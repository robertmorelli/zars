...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zars" is the name you will use in your source code to
                // import this module (e.g. `@import("zars")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "zars", .module = mod },
            },
        }),
    });
    ...
    // Build a freestanding WebAssembly runtime artifact for browser/Node harnesses.
    ...
    const install_wasm_runtime = b.addInstallArtifact(wasm_runtime, .{
        .dest_sub_path = "lib/zars_runtime.wasm",
    });
